...
while true; do
    ...
    cp three-gorges.gnuplot cuntan.gnuplot hankou.gnuplot hankou-prev.gnuplot yichang.gnuplot shashi-chenglingji.gnuplot parse.sh levels.txt /var/www/html/source
