...
while true; do
    ...
    cp levels_1.txt levels_2.txt flows.txt /var/www/html/source
    ...
    mv csv/three-gorges.csv csv/cuntan.csv csv/hankou.csv csv/hankou-prev.csv csv/yichang.csv csv/wulong.csv csv/cuntan-wulong.csv csv/shashi-chenglingji.csv /var/www/html/source
